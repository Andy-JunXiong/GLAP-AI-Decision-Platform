...
-- Existing isolated staging deployments need this additive migration before
-- Decision-to-Action binding code can be deployed.

ALTER TABLE {{SOURCE_DATABASE}}.fact_lifecycle_action_staging_v1
ADD COLUMNS (
